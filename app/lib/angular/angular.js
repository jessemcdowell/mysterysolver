 ...
 *
 * ```js
 * var mysterysolver = angular.module('mysterysolver', []);
 * mysterysolver.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://mysterysolver.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://mysterysolver.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('mysterysolver', []).config(function($sceDelegateProvider) {
 ...
 *        'http://mysterysolver.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="mysterysolverController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("mysterysolverController", function mysterysolverController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('mysterysolverWithSceDisabledmysterysolver', []).config(function($sceProvider) {
